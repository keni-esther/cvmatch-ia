...
define('GMAIL_PASS', 'nvlmcvucmfutrxhh');   // App Password Google
define('GMAIL_FROM_NAME', 'CVMatch IA');

function envoyerEmail($destinataire, $sujet, $corps_html)
{
  $host = 'smtp.gmail.com';
  $port = 587;
  $user = GMAIL_USER;
...
// ============ TEMPLATES EMAIL (palette orange/dark) ============
  ...
  <div style="max-width:520px;margin:30px auto;background:#262626;border-radius:12px;overflow:hidden;border:1px solid rgba(246,112,17,.3)">
    ...
    <div style="padding:32px">
      ...
      <p style="color:#878787;font-size:14px;line-height:1.6;margin-bottom:24px">
        Vous avez demandé un <strong style="color:#FFE4D0">code d\'accès recruteur</strong> pour CVMatch IA.<br>
        Voici votre code :
      </p>
      <div style="background:rgba(246,112,17,.1);border:2px dashed #F67011;border-radius:10px;padding:22px;text-align:center;margin-bottom:24px">
        <div style="font-size:36px;font-weight:800;color:#F67011;letter-spacing:10px">' . $code . '</div>
        <div style="font-size:12px;color:#878787;margin-top:8px">Code d\'accès recruteur</div>
      </div>
      <p style="color:#878787;font-size:13px;line-height:1.6;margin-bottom:20px">
        Utilisez ce code lors de votre inscription dans le champ <em style="color:#FFE4D0">"Code d\'accès recruteur"</em>.
      </p>
      <p style="color:#555;font-size:12px;border-top:1px solid rgba(246,112,17,.15);padding-top:16px;margin:0">
...
<div style="max-width:600px;margin:30px auto;background:#262626;border-radius:12px;overflow:hidden;border:1px solid rgba(246,112,17,.3)">
    <div style="background:linear-gradient(135deg,#F67011,#873800);color:white;padding:30px;text-align:center">
        ...
        <p style="margin:8px 0 0;opacity:.85;font-size:14px">Un recruteur vous a sélectionné !</p>
    </div>
    <div style="padding:36px 32px">
        <p style="color:#FFE4D0;font-size:15px;margin-bottom:14px">Bonjour <strong>' . $prenomCandidat . '</strong>,</p>
        <p style="color:#878787;font-size:14px;line-height:1.6;margin-bottom:20px">
            L\'entreprise <strong style="color:#F67011">' . $entrepriseRecruteur . '</strong> a vu votre profil sur CVMatch IA et souhaite vous contacter.
        </p>
        <div style="background:rgba(246,112,17,.08);border:1px solid rgba(246,112,17,.25);border-radius:10px;padding:18px 20px;margin-bottom:22px">
            <p style="color:#FFE4D0;font-size:13.5px;margin:0;line-height:1.6">
                Vous pouvez répondre directement à cet email ou vous connecter sur <strong>CVMatch IA</strong> pour voir les détails.
            </p>
        </div>
...
$digits .= '<span
  style="display:inline-block;width:44px;height:52px;line-height:52px;text-align:center;font-size:26px;font-weight:800;color:#F67011;background:rgba(246,112,17,.08);border:2px solid rgba(246,112,17,.3);border-radius:10px;margin:0 4px">'
  . $ch . '</span>';
}
return '
<!DOCTYPE html>
...
<body style="margin:0;padding:0;background:#161514;font-family:Arial,sans-serif">
  <div
    style="max-width:520px;margin:30px auto;background:#262626;border-radius:14px;overflow:hidden;border:1px solid rgba(246,112,17,.25)">
    <div style="background:linear-gradient(135deg,#F67011,#873800);padding:26px 32px;text-align:center">
      <h1 style="color:#fff;margin:0;font-size:24px;font-weight:800;letter-spacing:-0.5px">CVMatch IA</h1>
      <p style="color:rgba(255,255,255,.8);margin:6px 0 0;font-size:13px">Vérification de votre adresse email</p>
    </div>
    <div style="padding:36px 32px">
      ...
      <p style="color:#878787;font-size:14px;line-height:1.6;margin-bottom:28px">
        Vous avez demandé à créer un compte sur <strong style="color:#FFE4D0">CVMatch IA</strong>.<br>
        Voici votre code de vérification à 6 chiffres :
      </p>
      <div
        style="text-align:center;margin-bottom:28px;padding:20px;background:rgba(246,112,17,.05);border-radius:12px;border:1px solid rgba(246,112,17,.15)">
        ' . $digits . '
        <p style="color:#878787;font-size:11px;margin:14px 0 0">Valable pendant <strong style="color:#F67011">10
            minutes</strong></p>
      </div>
      <p style="color:#878787;font-size:13px;line-height:1.6;margin-bottom:20px">
        Saisissez ce code sur la page d\'inscription pour confirmer votre email et créer votre compte.
      </p>
      <div
        style="background:rgba(255,77,77,.08);border:1px solid rgba(255,77,77,.2);border-radius:8px;padding:12px 16px;margin-bottom:20px">
      ...
      <p
        style="color:#555;font-size:11px;border-top:1px solid rgba(246,112,17,.1);padding-top:14px;margin:0;text-align:center">
